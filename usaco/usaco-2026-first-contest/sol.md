...
如果 cB <= cA，那么最差情况是 B 类硬币有 k * cB + cB - 1 的情况，多出的 cB - 1 个无法兑换 A 硬币。

如果 cB >= cA，那么随着 x 中 B 类硬币增加，我们能获得的 A 类硬币呈折线式减少，因此我们可以尝试 x 中全是 B 类硬币的情况，以及兑换刚好多出 b - 1 个 B 类硬币的情况，在二者中取一个最差情况。
